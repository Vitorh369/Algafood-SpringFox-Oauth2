...
public class AlgaLinks {
	...
	public Link linkToEstatisticasVendasDiarias(String rel) {
	    ...
	    String pedidosUrl = linkTo(methodOn(EstaticaController.class)
	...
	public Link linkToConfirmacaoPedido(String codigoPedido, String rel) {
		return linkTo(methodOn(FluxoPedidoController.class)
				.confirmacao(codigoPedido)).withRel(rel);
	}
	...
	public Link linkToRestauranteFormasPagamento(Long restauranteId, String rel) {
		return linkTo(methodOn(RestauranteFormaPagementoController.class)
